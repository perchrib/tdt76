...
def test(queries=list(), location='./test'):
    ...
    """
    #create image that goes through first models
    ...
    for query in queries:
        ...
        """This is for clustering, unavailable because the clusters is not uploaded in the delivery"""
        #cluster_file = predict_cluster(img_feature)
        #similar_pics = find_most_similar_pics_in_cluster(img_feature, cluster_file)
